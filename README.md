...
汉明（HanMing）是一套面向企业与园区场景的前后端分离全栈数字化解决方案，由`后台管理系统`与`门户系统`两大核心子系统构成，为智慧园区管理、企业服务、人才服务等业务场景提供端到端技术支撑。
...
- **现代化前端工程**：基于 Vue 3 + TypeScript + Element Plus 构建响应式用户界面，提供流畅的用户体验与丰富的交互能力
